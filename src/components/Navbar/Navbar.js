        ...
        <nav className={styles.navbar} id="main-navbar">
            <div className={styles.container}>
                ...
                <div className={styles.navLinks}>
                    ...
                    <Link
                        href="/crew"
                        className={`${styles.navLink} ${pathname === '/crew' ? styles.navLinkActive : ''}`}
                    >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <Link
                        href="/checkout"
                        className={`${styles.navLink} ${pathname === '/checkout' ? styles.navLinkActive : ''}`}
                    >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {user && (
                    <div className={styles.userSection} ref={dropdownRef}>
                        ...
                        >
                            ...
                            <svg className={`${styles.chevron} ${showDropdown ? styles.chevronOpen : ''}`} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
